    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12" style="border-bottom: 1px solid #000;">
                <center>
                    <img src="<?= url('logos/kop-surat.png') ?>" style="width: 50%;border-radius: 5px;">
                </center>
                <p>&nbsp;</p>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding: 10px ">
                                    ...
                                    {{-- <p> {{$data_pegawai->nama_pegawai}} </p> --}}
                                    <p>{{ \Carbon\Carbon::parse($data_pengaduan->tgl_pengaduan)->translatedFormat('l, j F Y h:i') . ' - ' . $data_pegawai->nama_pegawai }}
                                    </p>
                                    ...
                                    @foreach ($tindakan as $item)
                                        <p  style="margin-bottom: -5px;">
                                          <strong>  {{ $item->employee->nama_pegawai . ' - ' . $item->employee->level_pegawai }} (Jawaban) </strong>
                                        </p>
                                        ...
                                        <p   style="margin-bottom: -5px; text-align:end;" ><strong> {{$resp->employee->nama_pegawai . ' - '. $resp->employee->level_pegawai}}  (Tanggapan)</strong> </p>
                                        @else
                                        <p   style="margin-bottom: -5px; text-align:end;" ><strong> -  (Tanggapan)</strong> </p>
