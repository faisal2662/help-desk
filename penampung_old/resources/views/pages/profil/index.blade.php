				...
				<center>
				  <form method="POST" enctype="multipart/form-data" id="form-upload" onsubmit="show(true)" action="<?= route('profil.upload') ?>">
					...
					<div class="form-group">
					  <label for="file-1">
						<img src="<?= url($data_pegawai->foto_pegawai) ?>" id="image-1" style="width: 120px;border-radius: 100%;cursor: pointer;"><br>
				...
				<div class="table-responsive">
				  <table class="table" style="width: 100%;">
					<thead>
					  <tr>
						<td>NPP</td>
						<td>: <?= htmlspecialchars($data_pegawai->npp_pegawai) ?></td>
					  </tr>
					  <tr>
						<td>Nama Lengkap</td>
						<td>: <?= htmlspecialchars($data_pegawai->nama_pegawai) ?></td>
					  </tr>
					  <tr>
						<td>Jenis Kelamin</td>
						<td>: <?= htmlspecialchars($data_pegawai->jenkel_pegawai) ?></td>
					  </tr>
					  <tr>
						<td>No.Telp</td>
					  ...
					  <tr>
						<td>Sebagai</td>
						<td>: <?= htmlspecialchars($data_pegawai->level_pegawai) ?></td>
					  </tr>
					  <tr>
						<td>Status</td>
					  ...
					  <tr>
						<td>Tanggal</td>
						<td>: <?= date('j F Y, H:i', strtotime($data_pegawai->tgl_pegawai)) ?></td>
					  </tr>
					</thead>
				  </table>
				</div>
