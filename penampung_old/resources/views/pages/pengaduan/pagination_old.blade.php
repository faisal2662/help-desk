	...
	<div class="row">
		...
		<?php foreach($jawaban as $data_jawaban){ ?>
			...
			<?php
				...
				}else if($data_jawaban->kantor_pegawai == 'Kantor Cabang'){
				...
				}else if($data_jawaban->kantor_pegawai == 'Kantor Wilayah'){
				...
				<div class="card">
				  <div class="card-body">
					...
					<?php if($pengaduan->count() > 0){ ?>
						...
						<?php if($data_pengaduan->status_pengaduan != 'Finish'  && $data_pegawai->sebagai_pegawai == 'PIC'){ ?>
					...
					<div class="card-title">
						<img src="<?= url($data_jawaban->foto_pegawai) ?>" style="width: 20px;height: 20px;border-radius: 100%;">
						<b>
							<?= htmlspecialchars($data_jawaban->nama_pegawai) ?>
						</b>
					</div>
							...
							<div class="card bg-primary text-white">
							  <div class="card-body">
								<div class="card-title text-white">
									<img src="<?= url($data_pegawai->foto_pegawai) ?>" style="width: 20px;height: 20px;border-radius: 100%;"> 
									<b><?= htmlspecialchars($data_pegawai->nama_pegawai) ?></b>
								</div>
