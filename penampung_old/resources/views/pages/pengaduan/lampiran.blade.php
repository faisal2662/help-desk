...
<?php
	...
	if($pengaduan->count() < 1){
		...
		->where([['tb_pegawai.id_pegawai', Session::get('id_pegawai')],['tb_pegawai.kantor_pegawai', $data_get_pegawai->kantor_pegawai],['tb_pegawai.id_bagian_kantor_pusat', $data_get_pegawai->id_bagian_kantor_pusat],['tb_pegawai.id_bagian_kantor_cabang', $data_get_pegawai->id_bagian_kantor_cabang],['tb_pegawai.id_bagian_kantor_wilayah', $data_get_pegawai->id_bagian_kantor_wilayah],['tb_pegawai.delete_pegawai','N'],['tb_pegawai.status_pegawai','Aktif'],['tb_pegawai.sebagai_pegawai','Mitra/Pelanggan'],['tb_pegawai.level_pegawai','Kepala Bagian Unit Kerja']])
		->get();
