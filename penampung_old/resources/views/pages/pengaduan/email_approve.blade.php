					...
					<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff;border-radius: 10px;">
						...
						<tr>
							<td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
								...
								<!-- detail pengaduan -->
								<h4>
									<img src="<?= url($data_pegawai->foto_pegawai) ?>" style="width: 20px;height: 20px;border-radius: 100%;"> <?= $data_pegawai->nama_pegawai ?>
								</h4>
								<p>
								...
								<p>
									Klasifikasi : <?= $data_pengaduan->klasifikasi_pengaduan ?>
								</p>
								...
								<p>
									Status : 
									<span style="padding:5px 10px;border-radius: 10px;background-color: #3498db;color: #fff;">
