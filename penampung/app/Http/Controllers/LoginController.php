...
class LoginController extends Controller
{
    ...
    public function authenticate(Request $request)
    {
        ...
        if($account->id_bagian_kantor_pusat == 0 && $account->id_bagian_kantor_cabang == 0 && $account->id_bagian_kantor_wilayah == 0){
            $kepala = DB::table('tb_kepala_unit_kerja')->where('id_pegawai', $account->id_pegawai)->first();
