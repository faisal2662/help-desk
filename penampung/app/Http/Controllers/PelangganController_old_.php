...
class PelangganController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        //         $bagian =  $bagian_kantor_pusat->where('id_kantor_pusat', $kepala_unit_kerja->id_bagian_kantor_pusat)->first();
        //         $id_unit_kerja = 'Pusat,' . $bagian->id_kantor_pusat;
        //         $bagian_unit = 'Semua Bagian';
        //         $id_bagian = '0';
        //     } elseif ($kepala_unit_kerja->id_bagian_kantor_cabang != 0) {
        //         $bagian = $bagian_kantor_cabang->where('id_kantor_cabang', $kepala_unit_kerja->id_bagian_kantor_cabang)->first();
        //         $id_unit_kerja = 'Cabang,' .  $bagian->id_kantor_cabang;
        //         $bagian_unit = 'Semua Bagian';
        //         $id_bagian = '0';
        //     }
        //     if ($kepala_unit_kerja->id_bagian_kantor_wilayah != 0) {
        //         $bagian = $bagian_kantor_wilayah->where('id_kantor_wilayah', $kepala_unit_kerja->id_bagian_kantor_wilayah)->first();
