...
class HolidayController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        try {
            ...
            $hari_libur->created_by = auth()->user()->employee_name;
            $hari_libur->save();
    ...
    {
        $hari_libur = Holiday::where('id_hari_libur', $id)->where('is_delete', 'N')->first();
        if(is_null($hari_libur))
        {
            return redirect()->route('hari_libur');
        }

        return view('pages.hari_libur.lihat', compact('hari_libur'));
    }
    ...
    public function datatables(Request $request)
    {
        ...
        foreach ($hari_libur as $value) {
            ...
            $detail = '<a href="' . route('hari_libur.show', $value->id_hari_libur). '"><span class="badge badge-info"><i class="bx bx-search-alt-2"></i> Lihat</span></a>';
            ...
            $value->action = $detail. "&nbsp;" . $update_data . "&nbsp;" . $delete_data;
    ...
    public function edit($id, Request $request)
    {
        try {
            ...
            $hari_libur->nama_hari_libur = $request->nama;
            $hari_libur->keterangan_hari_libur = $request->keterangan;
            $hari_libur->updated_by = auth()->user()->employee_name;
            $hari_libur->update();
    ...
    public function delete(Request $request)
    {
        ...
        try {
            $hari_libur = Holiday::where('id_hari_libur', $id)->first();
            $hari_libur->deleted_by = auth()->user()->employee_name;
