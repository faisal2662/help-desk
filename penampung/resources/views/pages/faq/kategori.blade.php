		...
		<div class="col-md-12">
			<div class="card">
			  <div class="card-body">
				...
				?>
				<form method="POST" enctype="multipart/form-data" onsubmit="show(true)" action="<?= route('faq.save.kategori') ?>">
				    <?= csrf_field() ?>

				    <div class="row">
				    	<div class="col-md-6">
							<label>Kategori </label>
							<input type="text" name="kategori" value="<?= old('kategori') ?>" class="form-control" required="" maxlength="255" placeholder="Harap di isi ...">
				    		<br>
				    	</div>
