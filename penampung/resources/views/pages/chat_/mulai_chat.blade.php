	  ...
	  <div class="card-body" id="group-chat" style="height: 385px;overflow-y: scroll;z-index: 17;overflow-x: hidden;">
		...
		<?php }else{ ?>
			...
			<?php foreach($chat as $data_chat){ ?>
				...
				<?php if($data_chat->id_pegawai == Session::get('id_pegawai')){ ?>

					<div class="row">
						<div class="col-md-6"></div>
						<div class="col-md-6" align="right" style="margin-bottom: 10px;">
							<label style="font-size: 12px;">
								<img src="<?= url($data_chat->foto_pegawai) ?>" style="width: 15px;height: 15px;border-radius: 100%;"> <?= $data_chat->nama_pegawai ?> (<?= $data_chat->sebagai_pegawai ?>)
							</label><br>
							...
							<span class="badge badge-primary" style="font-size: 15px;border-radius: 10px 10px 0 10px;white-space: normal;text-align: left;">
				...
				<?php }else{ ?>
					...
					<div class="row">
						<div class="col-md-6" style="margin-bottom: 10px;">
							...
							<span class="badge" style="background-color: lightgrey;font-size: 15px;border-radius: 10px 10px 10px 0;white-space: normal;text-align: left;">
							  <?= htmlspecialchars($data_chat->keterangan_chat) ?>
							</span><br>
