...
<?php
 $kontak =   DB::table('tb_kontak')
            ...
            ->where([['tb_kontak.id_kontak', $id_kontak], ['tb_kontak.delete_kontak', 'N']])
...
$chat = DB::table('tb_chat')
    ...
    ->where([['tb_chat.delete_chat', 'N'], ['tb_chat.room_chat', $id_kontak]])
    ...
    <div class="card-body">
        <div class="card-title" style="margin-bottom: 0;">
            <span style="font-size: 11px;">
                <i class='bx bx-user'></i> <?= $data_kontak->employee_name ?>
            </span><br>
            <b>
    ...
    <div class="card-body" id="group-chat" style="height: 385px;overflow-y: scroll;z-index: 17;overflow-x: hidden;">
        ...
        @php
            ...
            if ($kepala_unit->count() > 0) {
                ...
                $id_bagian_kantor_pusat = $data_kepala_unit->id_bagian_kantor_pusat;
                $id_bagian_kantor_cabang = $data_kepala_unit->id_bagian_kantor_cabang;
                $id_bagian_kantor_wilayah = $data_kepala_unit->id_bagian_kantor_wilayah;
            }

        @endphp
        <?php if($data_chat->id_bagian_kantor_pusat == $id_bagian_kantor_pusat && $data_chat->id_bagian_kantor_cabang == $id_bagian_kantor_cabang && $data_chat->id_bagian_kantor_wilayah == $id_bagian_kantor_wilayah){  ?>
            ...
            <div class="col-md-6" align="right" style="margin-bottom: 10px;">
                <label style="font-size: 12px;">
                    <img src="<?= asset('logos/avatar.png') ?>"
                        style="width: 15px;height: 15px;border-radius: 100%;"> <?= $data_chat->employee_name ?>
                    (<?= $data_chat->sebagai_posisi ?>)
                </label><br>
                ...
                <span class="badge badge-primary"
                    style="font-size: 13px;border-radius: 10px 10px 0 10px;font-weight:normal;white-space: normal;text-align: left;">
