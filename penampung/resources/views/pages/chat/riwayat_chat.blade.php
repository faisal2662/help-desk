...
<?php }else{ ?>
	...
	<?php  foreach($kontak as $data_kontak){ ?>
		...
		<div class="row">
			<div class="col-md-12" style="cursor: pointer;" onclick="set_id_kontak(<?= $data_kontak->id_kontak ?>);">
				<p <?= $id_kontak == $data_kontak->id_kontak ? 'class="bg-primary text-white" style="border-radius: 10px;padding: 10px;"' : '' ?> id="ellipsis">
					...
					<b>
						...
						<?php if($delivery->count() > 0){ ?>
							...
							<span class="badge badge-danger" style="zoom: 75%;position: absolute;top: 0;right: 0;border: 3px solid #fff;">
