...
<body>
                ...
                <div class="">
                    <table border="1" style="width: 100%;">
                        ...
                        <tbody>
                            ...
                            $kontak = App\Models\Kontak::with('chats.employee.NamaPosisi')
                            ...
                            <tr>
                                ...
                                <td style="padding: 10px ">
                                    ...
                                    @php
                                        ...
                                        $tindakan = App\Models\Jawaban::with(['employee.NamaPosisi', 'responses.employee.NamaPosisi'])
                                            ->where('id_pengaduan', $data_pengaduan->id_pengaduan)
                                    ...
                                    @foreach ($tindakan as $item)
                                        <p style="margin-bottom: -5px;">
                                            <strong>
                                                {{ $item->employee->employee_name . ' - ' . $item->employee->NamaPosisi->sebagai_posisi }}
                                                 </strong>
                                        </p>
                                        <p style="margin-bottom: -3px;"> (Jawaban) </p>
                                        <p  style="margin-bottom: -3px;"> {{ $item->keterangan_jawaban }} </p>
                                        <p> {{ \Carbon\Carbon::parse($item->tgl_jawaban)->translatedFormat('l, j F Y h:i') }}
                                        </p>
                                        ...
                                        @endphp --}}
                                            @if ($resp->employee)
                                                <p style="margin-bottom: -5px; text-align:end;"><strong>
                                                        {{ $resp->employee->employee_name . ' - ' . $resp->employee->NamaPosisi->sebagai_posisi }}

                                                    </strong> </p>
                                                    <p  style="margin-bottom: -3px; text-align:end;">(Tanggapan)</p>
                                            @else
                                                <p style="margin-bottom: -5px; text-align:end;">
                                                        (Tanggapan)</p>
                                            @endif
                                            <p style="text-align: end;margin-bottom: -3px;">{{ $resp->keterangan_tanggapan }} </p>
                                            <p style="text-align :end;"> {{ \Carbon\Carbon::parse($item->tgl_jawaban)->translatedFormat('l, j F Y h:i') }}
                                            </p>
                                        @endforeach 
                                    @endforeach
                                    ...
                                    @if ($item->posisi_pesan == '1')
                                        <div class="col-12 text-start " style=" margin-right: 10px;">
                                            <span class=" text-primary"
                                                style="display:block;">{{ $item->employee->employee_name . ' - ' . $item->employee->NamaPosisi->sebagai_posisi }}</span>
    ...
    <div class="row">
        ...
        <div class="col-md-6" align="right">
            {{-- Dicetak Oleh : <b><?= $data_pegawai->employee_name ?></b> --}}
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>. . .</p>
            <p>&nbsp;</p>
