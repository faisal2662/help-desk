	...
	<div class="row">
		<div class="col-md-12">
			<p>&nbsp;</p>
				<div class="card">
				  <div class="card-body">
					<div class="card-title"><b><i class='bx bx-plus'></i> Tambah Bagian Kantor Cabang</b></div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<form method="POST" enctype="multipart/form-data" onsubmit="show(true)" action="<?= route('bagian_kantor_cabang.save') ?>">
							  <?= csrf_field() ?>
