...
@section('title')
	Bagian Kantor Cabang - Helpdesk
@stop

	<?php if(isset($_GET['create'])){ ?>

		@include('pages.bagian_kantor_cabang.tambah')

	<?php }else if(isset($_GET['update'])){ ?>

		@include('pages.bagian_kantor_cabang.ubah')
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="card">
			  <div class="card-body">
				<div class="card-title"><b>Bagian Kantor Cabang</b></div>
				<p>
				...
				<?php if($bagian_kantor_cabang->count() < 1){ ?>
				...
				<?php }else{ ?>
						...
						<table class="table table-bordered table-striped table-hover" id="dataTables" style="width: 100%;">
							<thead>
							  <tr>
								...
								<td><b>Bagian Kantor Cabang</b></td>
								<td><b>Action</b></td>
							  </tr>
							</thead>
						</table>
					...
					<span style="display: none;">
						...
						<form method="POST" onsubmit="show(true)" id="form-delete" action="<?= route('bagian_kantor_cabang.delete') ?>">
							<?= csrf_field() ?>
	...
	@section('script')
		...
		<script type="text/javascript">
		  $('#dataTables').DataTable({
			...
			"serverSide": true,
			"ajax":{
				 "url": "<?= route('bagian_kantor_cabang.datatables') ?>",
				 "dataType": "json",
				 "type": "POST",
			...
			columns: [
				{data: 'no'},
				{data: 'nama_kantor_cabang'},
				{data: 'nama_bagian_kantor_cabang'},
				{data: 'action'},
			]
		  });
		</script>
