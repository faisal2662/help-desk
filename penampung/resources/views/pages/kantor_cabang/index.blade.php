...
@section('title')
	Helpdesk - Kantor Cabang
@stop

<?php if(isset($_GET['create'])){ ?>

	@include('pages.kantor_cabang.tambah')

<?php }else if(isset($_GET['update'])){ ?>

	@include('pages.kantor_cabang.ubah')
		...
		<div class="row">
			<div class="col-md-12">
				<p>&nbsp;</p>
					<div class="card">
					  <div class="card-body">
						<div class="card-title"><b>Kantor Cabang</b></div>
						<p>
						...
						<?php }else{ ?>
							...
							<span style="display: none;">
								...
								<form method="POST" onsubmit="show(true)" id="form-delete" action="<?= route('kantor_cabang.delete') ?>">
									<?= csrf_field() ?>
	...
	@section('script')
		...
		<script type="text/javascript">
		  $('#dataTables').DataTable({
			...
			"serverSide": true,
			"ajax":{
				 "url": "<?= route('kantor_cabang.datatables') ?>",
				 "dataType": "json",
				 "type": "POST",
