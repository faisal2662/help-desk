                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                            ...
                            <!-- detail pengaduan -->
                            <h4>
                                <img src=cid:gambar_cid "
                                    style="width: 20px;height: 20px;border-radius: 100%;">
                                <?= $data_pegawai->employee_name ?>
                            </h4>
                            <p>
                                Unit Kerja : <?= $kantor_pegawai ?> <br>
                                Unit Bagian Kerja : <?= $bagian_pegawai ?>
                            </p>
                            <hr style="border-style: dashed;">

                            <p>
                                Kepada : <?= $kantor_pengaduan . ' - ' . $bagian_pengaduan ?>
                            </p>
                            <p>
                            ...
                            <p>
                                Status :
                                <span
                                    style="padding:5px 10px;border-radius: 10px;background-color: #3498db;color: #fff;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 0 20px 0 20px;">
                            ...
                            <p> {{ $keterangan }} </p>
                            <p><strong> Tautan : </strong> <span><a href="{{ $url }}">Klik disini .</a></span> untuk langsung ke halaman </p>
                            <p> <strong>Tanggal : </strong> {{ date('l, d-m-Y')}} </p>
                            <p> <strong>Oleh : </strong> {{$name}} </p>
                        </td>
