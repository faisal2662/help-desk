            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                ...
                <tr>
                    <td style="padding: 0 20px 0 20px;">
                        <p style="font-size:13pt; ">Jawaban dari Kode Pengaduan : <strong>{{$kode_pengaduan}}</strong> </p>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 0 20px 0 20px;">
                        <p style="font-size:13pt; ">Tanggal : <strong>P-0384</strong> </p>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 0 20px ;"> <p>Keterangan: </p> <p>{{$jawaban}}</p> </td>
