			...
			<div class="col-md-6">
				<div class="card">
				  <div class="card-body">
					...
					<p>
						<a href="?filter=<?= $_GET['filter'] ?>&view=<?= $data_pengaduan->id_pengaduan ?>" class="text-info">
					...
					<p>
						...
						<span class="badge badge-<?= $status_pengaduan[$data_pengaduan->status_pengaduan] ?>">
                            ...
                            <?php if($data_pengaduan->status_pengaduan == "Late"){ ?>
                                ...
                                <?= str_replace(array('Holding','Hold'), array('Pengaduan SLA', 'Pengaduan SLA'), $data_pengaduan->status_pengaduan) ?>
                                <?php
                                    if($jawaban->count() < 1){
					...
					<?php if($jawaban->count() > 0){ ?>
						...
						<p>
							<?= number_format($jawaban->count()) ?> Jawaban | <?= number_format($tanggapan->count()) ?> Tanggapan
						</p>
