                    ...
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                            ...
                            <p>
                              ...
                              <span
                                    style="padding:5px 10px;border-radius: 10px;background-color: #003cac;color: #fff;">
                                    <?= $data_pengaduan->status_pengaduan ?>
                                </span>
                            </p>
                            <p>
                              <strong>  Tanggal : </strong> <?= date('j F Y, H:i', strtotime($data_pengaduan->tgl_pengaduan)) ?>
                            </p>
