                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <form method="POST" enctype="multipart/form-data" onsubmit="show(true)"
                                ...
                                {{-- @if ($kantor == 'Pusat')
                            <select name="kantor" id="unit_kerja" class="form-control"></select>
                            @foreach ($kantor_pusat as $item)
                            <option value="{{$item->id_kantor_pusat}}">K</option>
                            @endforeach
                            @else
                            ...
                            @endif --}}
                                ...
                                @if ($pegawai->NamaPosisi)
                                    ...
                                    <input type="text" id="sebagai_pegawai"
                                        value="{{ $pegawai->NamaPosisi->sebagai_posisi }}" readonly class="form-control">
                                @else
                                    <label for="">Nama Posisi</label>
                                    <select name="nama_posisi" id="nama_posisi" class="form-control">
                                        <option value="">- Pilih Salah Satu -</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="file-1">
                                        @if ($pegawai->foto_pegawai)
                                            <img src="<?= asset($pegawai->foto_pegawai) ?>" id="image-1"
...
@section('script')
    ...
    <script>
        // $('#nama_posisi').on('change', function(){
        //     let id = $(this).val();
        //     $.post("{{ route('getNamaPosisi') }}", {
        //         id:id,
        //         _token:'{{ csrf_token() }}'
        //     },function(res){
        //         console.log(res);
        //         $('#sebagai').val(res.data)
        //     }
        // )
        // })
        $('#nama_posisi').select2({
