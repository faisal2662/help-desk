...
@section('script')
    ...
    <script>
        ...
        function makeApiRequest(page) {
            return $.ajax({
                url: 'https://hrisdev-pro.jamkrindo.co.id/sf7/?qlid=HrisUser.getEmployee', // Ganti dengan URL API yang sesuai
                method: 'POST',
        ...
        function login() {
            ...
            const url =
                "https://hrisdev-pro.jamkrindo.co.id/sf7/?ofid=sfSystem.loginUser&originapp=hris_jamkrindo";
