                    ...
                    <center>
                        @if ($data_pegawai->foto_pegawai)
                            <img src="<?= asset($data_pegawai->foto_pegawai) ?>"
                                style="width: 120px;height: 120px;border-radius: 100%;margin-bottom: 15px;">
                        @else
                        ...
                        <table class="table" style="width: 100%;">
                            <thead>
                                ...
                                @if (auth()->user()->sebagai_pegawai == 'Administrator')
                                    <tr>
                                        <td>Created By</td>
                                        <td>: {{ $data_pegawai->created_by ? $data_pegawai->created_by : '-' }} </td>
                                    </tr>
                                    <tr>
                                        <td>Created Date</td>
                                        <td>:
                                            {{ $data_pegawai->created_date ? \Carbon\Carbon::parse($data_pegawai->created_date)->translatedFormat('l, d F Y') : '-' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Created By</td>
                                        <td>: {{ $data_pegawai->updated_by ? $data_pegawai->updated_by : '-' }} </td>
                                    </tr>
                                    <tr>
                                        <td>Updated Date</td>
                                        <td>:
                                            {{ $data_pegawai->updated_date ? \Carbon\Carbon::parse($data_pegawai->updated_date)->translatedFormat('l, d F Y') : '-' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Created By</td>
                                        <td>: {{ $data_pegawai->deleted_by ? $data_pegawai->deleted_by : '-' }} </td>
                                    </tr>
                                    <tr>
                                        <td>Deleted Date</td>
                                        <td>:{{ $data_pegawai->deleted_date ? \Carbon\Carbon::parse($data_pegawai->deleted_date)->translatedFormat('l, d F Y') : '-' }}
                                        </td>
                                    </tr>
                                @endif
                ...
                <div class="card-body">
                    ...
                    <form method="GET" onsubmit="show(true);">
                        <div class="input-group">
                            <input type="hidden" name="view" value="{{ $pegawai->id_pegawai }}" required=""
                                readonly="">
                            <input type="text" name="bulan" id="bulan" value="<?= $bulan ?>" readonly=""
                                required="" maxlength="255" placeholder="Atur Bulan ..." class="form-control">
...
@section('script')
    ...
    <script type="text/javascript">
        var xValues = [
            <?php foreach($hari as $data_hari){ ?> '<?= $data_hari ?>',
            <?php } ?>
        ];
        var yValues = [
