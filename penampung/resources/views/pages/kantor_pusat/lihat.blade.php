                        ...
                        <div class="col-12">
                            <div class="row mb-3">
                                ...
                                <div class="col"> <span><strong>Updated By :</strong>
                                        {{ $kantor_pusat->updated_by ? $kantor_pusat->updated_by : '-' }}
                                    </span> </div>
                                <div class="col"> <span><strong>Deleted By :</strong>
                                        {{ $kantor_pusat->deleted_by ? $kantor_pusat->deleted_by : '-' }}
                                    </span> </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <span><strong>Updated Date :</strong>
                                        {{ $kantor_pusat->updated_date ? \Carbon\Carbon::parse($kantor_pusat->updated_date)->translatedFormat('l, d F Y') : '-' }}</span>

                                </div>
                                <div class="col">

                                    <span><strong>Deleted Date :</strong>
                                        {{ $kantor_pusat->deleted_date ? \Carbon\Carbon::parse($kantor_pusat->deleted_date)->translatedFormat('l, d F Y') : '-' }}</span>
