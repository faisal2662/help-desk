...
@section('title')
	Helpdesk - Kantor Pusat
@stop

<?php if(isset($_GET['create'])){ ?>

	@include('pages.kantor_pusat.tambah')

<?php }else if(isset($_GET['update'])){ ?>

	@include('pages.kantor_pusat.ubah')
		...
		<div class="row">
			<div class="col-md-12">
				<p>&nbsp;</p>
					<div class="card">
					  <div class="card-body">
						<div class="card-title"><b>Kantor Pusat</b></div>
						<p>
						...
						<?php }else{ ?>
							...
							<span style="display: none;">
								...
								<form method="POST" onsubmit="show(true)" id="form-delete" action="<?= route('kantor_pusat.delete') ?>">
									<?= csrf_field() ?>
	...
	@section('script')
		...
		<script type="text/javascript">
		  $('#dataTables').DataTable({
			...
			"serverSide": true,
			"ajax":{
				 "url": "{{ route('kantor_pusat.datatables') }}",
				 "dataType": "json",
				 "type": "POST",
